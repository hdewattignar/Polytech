...
namespace GardenReporter2016
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void btnArea_Click(object sender, EventArgs e)
        {
            ...
            gardenManager.ProcessGardens(new DisplayDelegate(gardenManager.DisplayGardenArea));
        }

        private void btnCharges_Click(object sender, EventArgs e)
        {
            listBox1.Items.Clear();
            gardenManager.ProcessGardens(new DisplayDelegate(gardenManager.DisplayCustomerBalance));
        }
    }
}
